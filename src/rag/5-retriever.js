...
function createRetriever() {
    return __awaiter(this, void 0, void 0, function () {
        var embeddingLLM, pinecone, pineconeIndex, vectorStore;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    embeddingLLM = new google_genai_1.GoogleGenerativeAIEmbeddings({
                        model: "gemini-embedding-001",
                    });
                    pinecone = new pinecone_2.Pinecone();
                    pineconeIndex = pinecone.index("langchain-chatbot");
                    return [4 /*yield*/, pinecone_1.PineconeStore.fromExistingIndex(embeddingLLM, {
